    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('latest_term', models.ForeignKey(blank=True, to='legislator.LegislatorDetail', null=True)),
                ('legislator', models.ForeignKey(related_name='elected_candidate', blank=True, to='legislator.LegislatorDetail', null=True)),
            ],
        ),
        migrations.AlterUniqueTogether(
            name='candidates',
            unique_together=set([('uid', 'ad')]),
        ),
    ]
