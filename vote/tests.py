...
class VoteTest(TestCase):
    def setUp(self):
        ...
        Vote.objects.create(uid="08-01-YS-01-001", sitting_id="08-01-YS-01", vote_seq="001", content="test content", results={"abstain": 0, "not_voting": 4, "total": 113, "disagree": 46, "agree": 63})
