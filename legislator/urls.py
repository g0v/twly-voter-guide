...
urlpatterns = patterns('',
    ...
    url(r'^personal_property/(?P<index>stock|land|building|car|cash|deposit|bonds|fund|otherbonds|antique)/(?P<legislator_id>\d+)/$', views.personal_property, name='personal_property'),
